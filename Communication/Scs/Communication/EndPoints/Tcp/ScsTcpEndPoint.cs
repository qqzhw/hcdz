using System;
using Hcdz.Communication.Scs.Client;
using Hcdz.Communication.Scs.Client.Tcp;
using Hcdz.Communication.Scs.Server;
using Hcdz.Communication.Scs.Server.Tcp;

namespace Hcdz.Communication.Scs.Communication.EndPoints.Tcp
{
    /// <summary>
