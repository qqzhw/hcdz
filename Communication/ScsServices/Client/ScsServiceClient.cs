...
using Hcdz.Communication.ScsServices.Communication;
using Hcdz.Communication.ScsServices.Communication.Messages;

namespace Hcdz.Communication.ScsServices.Client
{
    /// <summary>
