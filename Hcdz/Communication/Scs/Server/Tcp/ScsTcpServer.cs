using Hcdz.Communication.Scs.Communication.Channels;
using Hcdz.Communication.Scs.Communication.Channels.Tcp;
using Hcdz.Communication.Scs.Communication.EndPoints.Tcp;

namespace Hcdz.Communication.Scs.Server.Tcp
{
    /// <summary>
